...
fn clone() {
    for builder in ts::iters::all() {
        let target = builder.build_into_iter();
...
fn next() {
    for builder in ts::iters::all() {
        // Arrange.
        let target = &mut builder.build_into_iter();
        let master = &mut builder.build_master_into_iter();
        // Act.
...
fn count() {
    for builder in ts::iters::all() {
        // Arrange.
        let target = builder.build_into_iter();
        let master = builder.build_master_into_iter();
        // Act.
